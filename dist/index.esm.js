...
import { useRefresh, useLastUpdated, UseHooksProvider } from '@nolannb/usehooks';
...
var getNodeUrl = function () {
    var randomIndex = random(0, nodes.length - 1);
    return nodes[randomIndex];
};

var RPC_URL = getNodeUrl();
var httpProvider = new Web3.providers.HttpProvider(RPC_URL, { timeout: 10000 });
...
var useWeb3 = function () {
    ...
    var _a = useState(library ? new Web3(library) : getWeb3NoAccount()), web3 = _a[0], setweb3 = _a[1];
    useEffect(function () {
...
var useContract = function (abi, address) {
    var web3 = useWeb3();
    return useMemo(function () { return getContract(abi, address, web3); }, [address, web3]);
};
...
var useERC20 = function (address) {
    var web3 = useWeb3();
    return useMemo(function () { return getContract(ERC20_ABI, address, web3); }, [address, web3]);
};

var useBalance = function (tokenAddress) {
    var contract = useERC20(tokenAddress);
    var _a = useState(BIG_ZERO), balance = _a[0], setBalance = _a[1];
    var account = useWeb3React().account;
    var web3 = useWeb3();
    var fastRefresh = useRefresh().fastRefresh;
    useEffect(function () {
...
var useChainBalance = function () {
    var _a = useState(BIG_ZERO), balance = _a[0], setBalance = _a[1];
    var account = useWeb3React().account;
    var _b = useLastUpdated(), lastUpdated = _b.lastUpdated, setLastUpdated = _b.setLastUpdated;
    var web3 = useWeb3();
    useEffect(function () {
        var fetchBalance = function () { return __awaiter(void 0, void 0, void 0, function () {
            var walletBalance;
...
var injected = new InjectedConnector({ supportedChainIds: [chainId] });
var walletconnect = new WalletConnectConnector({
    rpc: (_a = {}, _a[chainId] = rpcUrl, _a),
    qrcode: true,
});
var bscConnector = new BscConnector({ supportedChainIds: [chainId] });
(_b = {},
...
var UseHooksWeb3Context = React.createContext({});
var UseHooksWeb3Provider = function (_a) {
    var children = _a.children;
    return (jsx(UseHooksWeb3Context.Provider, __assign({ value: {} }, { children: jsx(Web3ReactProvider, __assign({ getLibrary: getLibrary }, { children: jsx(UseHooksProvider, { children: children }) })) })));
};

export { UseHooksWeb3Context, UseHooksWeb3Provider, useBalance, useBurnedBalance, useChainBalance, useContract, useERC20, useHasMinimumBalance };
